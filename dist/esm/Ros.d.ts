...
export declare class Ros {
    ...
    on<T extends EventEmitter.EventNames<EventTypes>>(event: T, fn: EventEmitter.EventListener<EventTypes, T>): this;
    off<T extends EventEmitter.EventNames<EventTypes>>(event: T, fn: EventEmitter.EventListener<EventTypes, T>): this;
    connect(url: string): void;
    close(): void;
    getTopics(callback: (result: {
        topics: string[];
        types: string[];
    }) => void, failedCallback?: (error: string) => void): void;
