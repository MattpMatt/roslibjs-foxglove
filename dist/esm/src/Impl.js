...
import { MessageReader as Ros1MessageReader, MessageWriter as Ros1MessageWriter, } from '@foxglove/rosmsg-serialization';
        ...
        return (this.#messageReaders.get(name) ??
            (() => {
                const reader = this.#isRos1
                    ...
                    : new Ros2MessageReader(schemaEncoding === 'ros2idl'
                        ? parseRos2idl(schema)
        ...
        return (this.#messageWriters.get(name) ??
            (() => {
                const writer = this.#isRos1
                    ...
                    : new Ros2MessageWriter(schemaEncoding === 'ros2idl'
                        ? parseRos2idl(schema)
                        : parse(schema, { ros2: true }));
