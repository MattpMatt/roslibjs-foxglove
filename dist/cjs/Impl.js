...
class Impl {
    ...
    constructor(url) {
        this.#client = new ws_protocol_1.FoxgloveClient({
            ws: new isomorphic_ws_1.default(url, ['foxglove.sdk.v1', ws_protocol_1.FoxgloveClient.SUPPORTED_SUBPROTOCOL]),
        });
        ...
        return (this.#messageReaders.get(name) ??
            (() => {
                const reader = this.#isRos1
                    ? new rosmsg_serialization_1.MessageReader((0, rosmsg_1.parse)(schema, { ros2: false }))
                    : new rosmsg2_serialization_1.MessageReader(schemaEncoding === 'ros2idl'
        ...
        return (this.#messageWriters.get(name) ??
            (() => {
                const writer = this.#isRos1
                    ? new rosmsg_serialization_1.MessageWriter((0, rosmsg_1.parse)(schema, { ros2: false }))
                    : new rosmsg2_serialization_1.MessageWriter(schemaEncoding === 'ros2idl'
                        ? (0, rosmsg_1.parseRos2idl)(schema)
                        : (0, rosmsg_1.parse)(schema, { ros2: true }));
